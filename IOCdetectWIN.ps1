...
$IOCPatterns = @( 
    ...
    '[\-|\/|–|—|―][Ww^]{1,2}[IiNnDdOoWwSsTtYyLlEe^]+\s+[Hh^]{1,2}[IiDdDdEeNn^]+', # Often used in malicious PowerShell commands https://github.com/splunk/security_content/blob/develop/detections/endpoint/powershell___connect_to_internet_with_hidden_window.yml
    ' -NoP ',                                      # Often used in malicious PowerShell commands 
    '-ep bypass',                                  # Often used in malicious PowerShell commands
    '(?:csc.exe|cvtres.exe).*?\\AppData\\',        # Often used in malicious PowerShell commands https://www.sentinelone.com/labs/solarwinds-understanding-detecting-the-supernova-webshell-trojan/
    ...
    'C:\\Users\\.*?\\AppData\\[^\\].*?\b.lnk\b',  #WIP maybe add .js .exe, .lnk, etc https://stackoverflow.com/questions/37750620/regular-expression-for-folder-path
    '%COMSPEC%',
